...
@objc public protocol GrowingTextViewDelegate: UITextViewDelegate {
    ...
    @objc optional func textViewDidBegin(_ textView: GrowingTextView)
    @objc optional func textViewDidEnd(_ textView: GrowingTextView)
...
open class GrowingTextView: UITextView {
    ...
    private func commonInit() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(textViewDidBegin), name: UITextView.textDidBeginEditingNotification, object: self)
    }
    ...
    @objc func textViewDidBegin(notification: Notification) {
        if let delegate = delegate as? GrowingTextViewDelegate {
            delegate.textViewDidBegin?(self)
        }
    }
}
