...
//    public static let defalutMainColorColor: CGColor = #colorLiteral(red: 0.1921568627, green: 0.1921568627, blue: 0.1921568627, alpha: 1) // #313131
//    public static let defalutDarkShadowColor: CGColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1) //000000
//    public static let defalutLightShadowColor: CGColor = #colorLiteral(red: 0.2549019608, green: 0.2549019608, blue: 0.2549019608, alpha: 1) //#414141
    public static let defalutMainColorColor: CGColor = #colorLiteral(red: 0.9411764706, green: 0.9411764706, blue: 0.9411764706, alpha: 1) // #F0F0F0
    public static let defalutDarkShadowColor: CGColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1) //FFFFFF
    public static let defalutLightShadowColor: CGColor = #colorLiteral(red: 0.8039215803, green: 0.8039215803, blue: 0.8039215803, alpha: 1) //#CDCDCD

    public static let defalutShadowOffset: CGSize = .init(width: 2, height: 2)
    public static let defalutShadowOpacity: Float = 1
    public static let defalutShadowRadius: CGFloat = 5
    public static let defalutCornerRadius: CGFloat = 5
